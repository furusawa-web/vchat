...
export class LAppModel extends CubismUserModel {
    ...
    public update(): void {
        ...
        if (this._motionManager.isFinished()) {
            ...
            //20190915 furusawa 待機中はモーションを固定して再生に変更
            // 0:手が下 1:腕組
            ...
            //} else {
            //    = false;
            //    this.startMotion(LAppDefine.MotionGroupTapBody, motionNum, LAppDefine.PriorityNormal);
            //}
        ...
        if (this._lipsync) {
            ...
            let value: number = ripSyncValue; // 0;  // リアルタイムでリップシンクを行う場合、システムから音量を取得して、0~1の範囲で値を入力します。
